<div class="page-header">
    ...
    <div class="pull-right">
        <a 
            href="<?php echo $this->webroot . 'admin/colors/color_add' ?>" 
                                        ...
                                        <tr>
                                          ...
                                          <td class="update_status">
                                           ...
                                           ($color['Color']['status'] == 1 )?
                                                    $this->Html->link(
                                                            'Active', '/colors/update_status/' . $color['Color']['id'], array(
                                                        'class' => 'label label-success',
                                                        'rel' => $color['Color']['id']
                                                            )
                                                    ) :
                                                    $this->Html->link(
                                                            'Inactive', '/colors/update_status/' . $color['Color']['id'], array(
                                            ...
                                            <?php
                                            echo $this->Html->link(
                                                    'View', '/admin/colors/color_view/' . $color['Color']['id'], array(
                                            ...
                                            echo '&nbsp';
                                              echo $this->Html->link(
                                                        'Edit', '/admin/colors/color_edit/' . $color['Color']['id'], array(
                                                    'class' => 'label label-success',
                                                    'rel' => $color['Color']['id']
                                                        )
                                                );
                                            ?>
                                             <button class="label btn-danger del" value="<?php echo $color['Color']['id']; ?>"  id="del_<?php echo $color['Color']['id']; ?>" msg="Color" >Delete</button>
                                        </td>
                                        </tr>
                                        <?php
                                        $i++;
...
<script>
    $(document).ready(function () {
       ...
       $(document.body).on('click', '.update_status a', function (e) {
            ...
            $.ajax({
                url: "<?php echo $this->webroot . 'admin/colors/update_status/' ?>" + _id,
                cache: false
            }).done(function (html) {
                if (html === '1') {
