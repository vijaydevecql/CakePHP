<div class="page-header">
	...
	<div class="row">
            <div class="col-sm-9">
                <?php echo $this->Form->create('Pattern', array('class' => 'form-horizontal','enctype' => 'multipart/form-data')); ?>
                        ...
                        <div class="input-group input-group-file">
                            ...
                            <span class="input-group-btn">
                                <span class="btn btn-success btn-file">
                                    ...
                                    <input type="file" accept="image/*" id="file" name="data[Pattern][image]" >
         ...
         <br>
               ...
               <div class="form-group">
                    <div class="col-sm-9 col-sm-offset-3">
                        ...
                        <a href="<?php echo $this->webroot;?>admin/patterns" type="reset" class="btn btn-default btn-outline">Back</a>
                    </div>
                </div>
            </div>
        </div>
