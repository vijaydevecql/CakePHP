                        ...
                        <div class="input-group input-group-file">
                            ...
                            <span class="input-group-btn">
                                <span class="btn btn-success btn-file">
                                    ...
                                    <input type="file" accept="image/*" id="file" name="data[Collection][image]">
                                    
                                </span>
                            </span>
                        </div>
                    <img src="<?php echo $this->webroot.'files/collections/'.$this->request->data['Collection']['image'];?>" name="image_1" id="image" height="100px" width="100px" >
                    </div>
                </div>
         <br>
                <div class="form-group">
                    <div class="col-sm-9 col-sm-offset-3">
                        ...
                        <a href="<?php echo $this->webroot;?>admin/collections" type="reset" class="btn btn-default btn-outline">Cancel</a>
                    </div>
                </div>
            </div>
        </div>
