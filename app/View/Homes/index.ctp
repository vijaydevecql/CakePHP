...
<?php if(count($collection)){ ?>
	...
	<div class="col-md-4 col-md-offset-4">
		<div class="collect uper_colect">
			<h3><?php echo strtoupper(trim($collection['Content']['name']))?></h3>
			<h2><?php echo strtoupper(trim($collection['Content']['short_description']))?></h2>
		...
		<div class="row">
			...
			<div class="col-md-4 col-sm-4 no_padding">
				<div class="loyi_block">
					...
					<video width="100%" height="100%"  poster="<?php echo $this->webroot.'files/default/'?>video1.png" src="<?php echo $this->webroot.'files/default/'?>loyi1.mp4" class = "myvideo"></video>
				</div>
			</div>
			<div class="col-md-4 col-sm-4 no_padding">
				<div class="loyi_block">
					<!-- <iframe width="100%" height="300" src="https://www.youtube.com/embed/AKWHfWtMALg"></iframe> -->
					<video width="100%" height="100%"  poster="<?php echo $this->webroot.'files/default/'?>video2.png" src="<?php echo $this->webroot.'files/default/'?>loyi2.mp4" class = "myvideo"></video>
				</div>
			</div>
			...
			<div class="col-md-4 col-sm-4 no_padding">
				<div class="loyi_block">
					...
					"  poster="<?php echo $this->webroot.'files/default/'?>video3.png" src="<?php echo $this->webroot.'files/default/'?>loyi3.mp4" class = "myvideo"></video>
								...
								foreach ($collection_record as $key => $value) {
									...
									<h2>
										<a
											...
											href="<?php echo $this->webroot . 'collection/' . $value['Collection']['slug']; ?>" >
