<section class="content-header">
 ...
 <section class="content">
	...
	<tr>
		...
		<td><?php echo h($content['Content']['position']); ?>&nbsp;</td>

		<td><?php   
		$page_type =  [1 => 'Home', 2 => 'About', 3 => 'Collection', 4 => 'Terms' ,5 => 'Privacy Policy'];
		echo $page_type[$content['Content']['page_type']]; ?>&nbsp;</td>
		<td><?php echo strip_tags(substr($content['Content']['short_description'],0,80)); ?>......&nbsp;</td>
		<?php
		// echo
